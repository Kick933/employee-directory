    ...
    if (member.isCeo) {
        return (
            <div className="my-6 mx-auto bg-yellow-300 shadow-lg rounded-xl w-3/5 grid grid-flow-rows sm:grid-rows-2 lg:grid-flow-col px-auto py-2 align-middle">
                <p className="text-center my-4 text-xs  lg:border-black lg:border-r font-bold col-span-1">{member.name}</p>
                <p className="text-center my-4 text-xs lg:border-black lg:border-r font-bold col-span-1">{`CEO`}</p>
    ...
    if (member.isHead) {
        ...
        return (
            <div className="my-6 mx-auto bg-yellow-300 shadow-lg rounded-xl w-3/5 grid grid-flow-rows sm:grid-rows-2 lg:grid-flow-col px-auto py-2 align-middle">
                ...
                <p className="text-center my-4 text-xs lg:border-black lg:border-r col-span-1">{`Head of ${member.department}`}</p>
