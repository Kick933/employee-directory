        ...
        teams.map((team, teamindex) => (
            <div key={uuidv4()} className="w-10/12 rounded-3xl bg-blue-200 text-center mx-auto my-6 py-6">
                <div className="grid grid-rows-2 justify-center py-2 items-center sm:grid-cols-2 sm:p-0 sm:m-0">
                    ...
                    <button className="bg-green-400 w-40 text-md p-1 rounded-md active:bg-green-600 hover:bg-green-500 mx-auto my-2" onClick={() => addMember(teamindex)}>Add Member</button>
                    <button className="bg-green-400 w-40 text-md p-1 rounded-md active:bg-green-600 hover:bg-green-500 mx-auto my-2" onClick={() => editTeam(teamindex)}>Edit</button>
                </div>
