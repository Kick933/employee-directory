    ...
    return (
        <div className="w-10/12 rounded-3xl bg-blue-200 text-center mx-auto my-6 py-6">
            <div className="grid grid-rows-2 justify-center py-2 items-center sm:grid-cols-2 sm:p-0 sm: m-0">
                ...
                <button className="bg-green-400 text-md p-1 rounded-md active:bg-green-500 focus:ring-2 focus:ring-green-600 m-auto" departmentindex={props.departmentindex} teamindex={props.teamindex}>Add Member</button>
            </div>
